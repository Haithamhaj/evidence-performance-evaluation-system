...
CREATE TYPE "GitHubProgressReviewDisposition" AS ENUM ('no_match', 'ambiguous');
...
CREATE TABLE "GitHubProgressReview" (
  ...
  "candidateRuleIds" JSONB NOT NULL,
  "createdAt" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,

  CONSTRAINT "GitHubProgressReview_pkey" PRIMARY KEY ("id"),
  CONSTRAINT "GitHubProgressReview_sourceEventId_key" UNIQUE ("sourceEventId"),
  CONSTRAINT "GitHubProgressReview_candidate_rules_array" CHECK (
    jsonb_typeof("candidateRuleIds") = 'array'
  )
);

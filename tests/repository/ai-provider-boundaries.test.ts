...
describe("AI provider boundary", () => {
  it("rejects provider SDK imports and direct provider HTTP routes outside ai-routing", () => {
    ...
    expect(result.stderr).toContain("metacall-bind-call-instance-before-safe.ts.fixture");
    expect(result.stderr).toContain("metacall-call-call-static-before-safe.ts.fixture");
    expect(result.stderr).toContain("metacall-apply-call-multilevel-before-safe.ts.fixture");
    expect(result.stderr).toContain("bound-reflect-apply-instance-before-safe.ts.fixture");
    expect(result.stderr).toContain("bound-reflect-apply-static-before-safe.ts.fixture");
    expect(result.stderr).toContain("optional-bound-metacall-before-safe.ts.fixture");
    expect(result.stderr).toContain("computed-metacall-alias-before-safe.ts.fixture");
    expect(result.stderr).toContain("returned-arrow-alias-before-safe.ts.fixture");
    expect(result.stderr).toContain("returned-arrow-optional-before-safe.ts.fixture");
    expect(result.stderr).toContain("returned-arrow-bound-before-safe.ts.fixture");
    expect(result.stderr).toContain("returned-arrow-static-subclass-before-safe.ts.fixture");
    expect(result.stderr).toContain("reflective-define-property-call-before-safe.ts.fixture");
    expect(result.stderr).toContain("reflective-define-properties-bind-before-safe.ts.fixture");
    expect(result.stderr).toContain("reflective-set-bound-reflect-apply-before-safe.ts.fixture");
    expect(result.stderr).toContain("reflective-unresolved-target-alias-before-safe.ts.fixture");

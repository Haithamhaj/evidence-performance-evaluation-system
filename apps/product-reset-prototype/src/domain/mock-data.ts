...
export const projects: readonly Project[] = [
  {
    ...
    latestUpdate: t(
      "اكتمل معيار النوايا العربية وبدأت مراجعة الأمان.",
      "Arabic intent benchmark completed; security review started.",
    ),
  ...
  },
  {
    ...
    latestUpdate: t(
      "نجحت تجربة الضوضاء الخليجية ضمن الحد المستهدف.",
      "Gulf noise test passed the target threshold.",
    ),
...
export const workstreams: readonly Workstream[] = [
  {
    ...
    purpose: t(
      "قياس وتحسين فهم النوايا العربية المختلطة.",
      "Measure and improve mixed-Arabic intent understanding.",
    ),
    owner: "هيثم الحاج",
  ...
  },
  {
    ...
    purpose: t(
      "عرض صحة المنتج دون تحويل النشاط إلى أداء فردي.",
      "Show product health without turning activity into individual performance.",
    ),
    owner: "نورة الشمري",
    ...
    criteria: [
      t("تفصل صحة المشروع عن تقييم الأفراد", "Separates project health from employee evaluation"),
    ],
    responsibilityHistory: [
      {
        person: "نورة الشمري",
  ...
  },
  {
    ...
    purpose: t(
      "إدخال بيانات العميل ضمن حدود الخصوصية.",
      "Ingest client data within privacy boundaries.",
    ),
    owner: "عمر قاسم",
    contributors: ["هيثم الحاج"],
    health: "at_risk",
  ...
  },
  {
    ...
    purpose: t(
      "اختبار النسخ الصوتي على لهجات وسياقات واقعية.",
      "Test transcription on realistic dialects and contexts.",
    ),
    owner: "هيثم الحاج",
    ...
    criteria: [
      t(
        "يحفظ المصدر والنص الخام والمصحح",
        "Preserves source, raw transcript, and edited transcript",
      ),
    ],
    responsibilityHistory: [
      {
  ...
  },
  {
    ...
    purpose: t(
      "دمج الاستجابة الصوتية مع الاسترداد الآمن.",
      "Integrate voice response with safe recovery.",
    ),
    owner: "سارة مراد",
    contributors: ["هيثم الحاج"],
    health: "at_risk",
...
const itemSeeds = [
  [
    "wi-101",
    "اعتماد مجموعة النوايا الحرجة",
    "Approve critical intent set",
    "project-nabd",
    "ws-intent-quality",
    "in_review",
    "urgent",
  ...
  [
    "wi-102",
    "تحليل أخطاء العربية المختلطة",
    "Analyze mixed-Arabic errors",
    "project-nabd",
    "ws-intent-quality",
    "in_progress",
    "high",
  ...
  [
    "wi-104",
    "تجربة تحسين معيار النوايا",
    "Run intent benchmark improvement",
    "project-nabd",
    "ws-intent-quality",
    "in_progress",
    "high",
  ...
  [
    "wi-105",
    "مراجعة حدود لوحة الجودة",
    "Review quality dashboard boundaries",
    "project-nabd",
    "ws-quality-dashboard",
    "ready",
    "high",
    "2026-07-20",
  ],
  [
    "wi-106",
    "تصميم حالة المشروع الصحية",
    "Design project health state",
    "project-nabd",
    "ws-quality-dashboard",
    "planned",
    "medium",
  ...
  [
    "wi-108",
    "قرار بوابة بيانات العميل",
    "Decide client data gateway",
    "project-nabd",
  ...
  [
    "wi-111",
    "توسيع عينات الضوضاء الخليجية",
    "Expand Gulf noise samples",
    "project-sawt",
    "ws-speech-eval",
    "in_progress",
    "high",
  ...
  [
    "wi-112",
    "توثيق عائق بوابة العميل",
    "Document client gateway blocker",
    "project-sawt",
    "ws-speech-eval",
    "ready",
    "medium",
  ...
  [
    "wi-113",
    "مراجعة نصوص Levantine",
    "Review Levantine transcripts",
    "project-sawt",
    "ws-speech-eval",
    "planned",
    "medium",
  ...
  [
    "wi-114",
    "اختبار النص المختلط",
    "Test mixed-language transcript",
    "project-sawt",
    "ws-speech-eval",
    "in_review",
    "high",
  ...
  [
    "wi-118",
    "تحديث معيار أمان الصوت",
    "Update voice safety criterion",
    "project-sawt",
    null,
    "planned",
    "medium",
  ...
  [
    "wi-119",
    "تأكيد مساهمة الاختبار",
    "Confirm testing contribution",
    "project-sawt",
    "ws-speech-eval",
    "in_review",
    "medium",
  ...
  [
    "wi-120",
    "إغلاق تجربة الانقطاع",
    "Close interruption experiment",
    "project-sawt",
    "ws-voice-runtime",
    "done",
    "low",
  ...
  ([id, ar, en, projectId, workstreamId, status, priority, dueDate], index) => ({
    ...
    blockerReason:
      status === "blocked"
        ...
        : null,
    nextAction: t(
      "تأكيد الخطوة التالية مع أصحاب العلاقة",
      "Confirm the next step with participants",
    ),
...
export const inboxItems: readonly InboxItem[] = [
  {
    id: "in-1",
    kind: "manager_clarification",
    title: t("طلب توضيح من المدير", "Manager clarification request"),
    detail: t(
      "وضح أثر قرار بوابة البيانات على الموعد.",
      "Clarify how the data-gateway decision affects the target date.",
    ),
    actionable: true,
    workItemId: "wi-108",
    occurredAt: "2026-07-18T07:40:00Z",
  },
  {
    id: "in-2",
    kind: "mention",
    title: t("إشارة في تعليق", "Comment mention"),
    detail: t(
      "ذكرتك نورة في مراجعة لوحة الجودة.",
      "Noura mentioned you in the quality-dashboard review.",
    ),
    actionable: true,
    workItemId: "wi-105",
    occurredAt: "2026-07-18T06:50:00Z",
  },
  {
    id: "in-3",
    kind: "criteria_acknowledgment",
    title: t("إقرار معيار جديد", "Criteria acknowledgment"),
    detail: t("معيار الخصوصية جاهز للمراجعة.", "The privacy criterion is ready for review."),
    actionable: true,
    workItemId: null,
    occurredAt: "2026-07-17T15:20:00Z",
  },
  {
    id: "in-4",
    kind: "github_suggestion",
    title: t("دليل GitHub مقترح", "Suggested GitHub evidence"),
    detail: t("نتيجة CI ناجحة للمعيار العربي.", "A successful CI result for the Arabic benchmark."),
    actionable: true,
    workItemId: "wi-104",
  ...
  },
  {
    ...
    title: t("طلب توضيح الإسناد", "Attribution clarification"),
    detail: t(
      "حدد مساهمتك الجزئية في اختبار الضوضاء.",
      "Describe your partial contribution to the noise test.",
    ),
    actionable: true,
    workItemId: "wi-111",
  ...
  },
  {
    ...
    title: t("تذكير تحديث الخميس", "Thursday update reminder"),
    detail: t(
      "تكامل بيانات العميل يحتاج تحديثاً جوهرياً أو تأكيداً سريعاً.",
      "Client Data Integration needs a substantive update or quick confirmation.",
    ),
    actionable: true,
    workItemId: "wi-108",
  ...
  {
    id: "in-7",
    kind: "evaluation_action",
    title: t("إجراء تقييم قادم", "Upcoming evaluation action"),
    detail: t(
      "راجع معاينة الحقائق للفترة الحالية.",
      "Review the Fact View preview for the current period.",
    ),
    actionable: true,
    workItemId: null,
...
export const activityEvents: readonly ActivityEvent[] = [
  {
    id: "act-1",
    kind: "verified_fact",
    title: t("اكتمل خط الأساس", "Baseline completed"),
    detail: t(
      "تم تشغيل 420 حالة وحفظ نتائج المصدر.",
      "420 cases were run and source results retained.",
    ),
    occurredAt: "2026-07-18T08:20:00Z",
    actor: "هيثم الحاج",
    projectId: "project-nabd",
  ...
  },
  {
    ...
    title: t("نتيجة CI مقترحة", "CI result suggested"),
    detail: t("اقتراح فقط؛ لم يؤكد كدليل بعد.", "Suggestion only; not yet confirmed as evidence."),
    occurredAt: "2026-07-18T07:50:00Z",
    actor: "GitHub App",
    projectId: "project-nabd",
    workstreamId: "ws-intent-quality",
    workItemId: "wi-104",
  },
  {
    id: "act-3",
    kind: "blocker",
    title: t("عائق بوابة العميل", "Client gateway blocker"),
    detail: t(
      "بانتظار قرار وصول رسمي؛ لا توجد نسبة أداء مرتبطة.",
      "Waiting for a formal access decision; no performance value is attached.",
    ),
    occurredAt: "2026-07-17T14:10:00Z",
    actor: "عمر قاسم",
    projectId: "project-nabd",
    workstreamId: "ws-client-integration",
    workItemId: "wi-108",
  },
  {
    id: "act-4",
    kind: "responsibility_change",
    title: t("بدأت فترة مسؤولية", "Responsibility window started"),
    detail: t("بدأ هيثم ملكية تقييم الكلام.", "Haitham began ownership of speech evaluation."),
    occurredAt: "2026-05-20T00:00:00Z",
    actor: "النظام",
    projectId: "project-sawt",
    workstreamId: "ws-speech-eval",
    workItemId: null,
  },
];
...
export const evidenceSuggestions: readonly EvidenceSuggestion[] = [
  {
    ...
    title: t("تحسين عزل النص المختلط", "Improve mixed-text isolation"),
    sourceLabel: "PR #81",
    projectId: "project-nabd",
    workstreamId: "ws-quality-dashboard",
    workItemId: "wi-105",
    state: "suggested",
    executionMode: null,
    context: null,
  },
  {
    id: "ev-2",
    sourceKind: "commit",
    title: t("إضافة حالات معيار عربية", "Add Arabic benchmark cases"),
    sourceLabel: "commit 8fd1c2a",
    projectId: "project-nabd",
    workstreamId: "ws-intent-quality",
    workItemId: "wi-104",
    state: "suggested",
  ...
  {
    id: "ev-3",
    sourceKind: "ci_result",
    title: t("نجاح اختبارات النوايا", "Intent tests passed"),
    sourceLabel: "CI run #194",
    projectId: "project-nabd",
    workstreamId: "ws-intent-quality",
    workItemId: "wi-104",
    state: "suggested",
  ...
  },
  {
    ...
    title: t("نتيجة ضوضاء خليجية", "Gulf noise test result"),
    sourceLabel: "eval-2026-07-17",
    projectId: "project-sawt",
    workstreamId: "ws-speech-eval",
    workItemId: "wi-111",
    state: "confirmed",
    executionMode: "mixed",
    context: t(
      "تحقق الفريق من النتيجة ووصفت مساهمتي الجزئية.",
      "The team verified the result and I described my partial contribution.",
    ),
  },
  {
    id: "ev-5",
    sourceKind: "file",
    title: t("تقرير تحليل الأخطاء", "Error analysis report"),
    sourceLabel: "error-analysis.pdf",
    projectId: "project-nabd",
    workstreamId: "ws-intent-quality",
    workItemId: "wi-102",
    state: "confirmed",
    executionMode: "manual",
    context: t("يربط الأخطاء بقرارات العينة.", "Links errors to sample decisions."),
  },
  {
    id: "ev-6",
    sourceKind: "link",
    title: t("مرجع سياسة العميل", "Client policy reference"),
    sourceLabel: "client.example/policy",
    projectId: "project-nabd",
    workstreamId: "ws-client-integration",
    workItemId: "wi-108",
    state: "suggested",
  ...
  },
  {
    ...
    title: t("شاشة لوحة الجودة", "Quality dashboard screen"),
    sourceLabel: "quality-dashboard.png",
    projectId: "project-nabd",
    workstreamId: "ws-quality-dashboard",
    workItemId: "wi-107",
    state: "confirmed",
    executionMode: "ai_assisted",
    context: t("لقطة موثقة مع مصدر ونتيجة.", "Contextualized screenshot with source and result."),
  },
  {
    id: "ev-8",
    sourceKind: "architecture_diagram",
    title: t("مخطط استرداد المكالمة", "Call recovery architecture"),
    sourceLabel: "recovery-flow.svg",
    projectId: "project-sawt",
    workstreamId: "ws-voice-runtime",
    workItemId: "wi-115",
    state: "suggested",
    executionMode: null,
    context: null,
...
export const readinessFacts: readonly ReadinessFact[] = [
  {
    ...
    employeeClaim: t(
      "حسّنت موثوقية معيار النوايا العربية.",
      "Improved the reliability of the Arabic intent benchmark.",
    ),
    supportedFacts: [
    ...
    unclearParts: [
      t(
        "أثر التحسين على بيانات العميل لم يتحقق بعد.",
        "Impact on client data is not yet verified.",
      ),
    ],
    result: t(
      "معيار قابل لإعادة الاختبار ومراجعة أمان مفتوحة.",
      "A reproducible benchmark with an open security review.",
    ),

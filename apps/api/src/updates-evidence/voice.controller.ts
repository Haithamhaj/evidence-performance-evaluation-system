...
for (const [method, path] of [["start", ""], ["revise", ":voiceSessionId/revisions"], ["confirm", ":voiceSessionId/confirm"]] as const) {
  ...
  Body()(VoiceUpdatesController.prototype, method, method === "start" ? 1 : 2);

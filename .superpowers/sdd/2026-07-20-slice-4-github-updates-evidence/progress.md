...
Task 5: implementation and first hardening commits `701138b`, `d9c652d`, and `5741df2`; private multipart media resolution, artifact descriptors, current-scope reauthorization, locking, cancellation, and truthful cleanup are in place. Retry/resume and the remaining dedicated authorization/concurrency regressions remain open for the next continuation; P2/P3 are tracked in issue #9.

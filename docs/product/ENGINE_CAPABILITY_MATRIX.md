...
| Receive coaching and maintain development actions           | CAP-035–036      | Partial            | Protected engine exists; authenticated acceptance journey remains              |
...
| Support coaching and formal development                        | CAP-035–036      | Partial         | Bounded shared-action support exists; production UI remains |

...
**Authoritative sources:** `PROJECT_REFERENCE.md` §§13, 15, 25, 35; rubric ARL-01/02; approved engine-first decision | **Owner module:** planned bounded Research & Experiments domain; existing Projects, Work Items, Documents, Updates & Evidence, and AI Router remain source owners | **Inputs/sources:** Project/Workstream, documents, Tasks, papers/repos/notes/evidence | **AI role:** draft framing, compare sources, expose uncertainty
...
**Status:** PLANNED | **External gate:** none | **Frontend implications:** one research workspace connected to Project/Task/Evidence, not a separate generic knowledge platform

...
**Authoritative sources:** `PROJECT_REFERENCE.md` §§13, 15, 25, 35; rubric ARL-01/02; approved engine-first decision | **Owner module:** undecided pending E3 ownership audit | **Inputs/sources:** Project/Workstream, documents, Tasks, papers/repos/notes/evidence | **AI role:** draft framing, compare sources, expose uncertainty
...
**Authoritative sources:** rubric ARL-03; `PROJECT_REFERENCE.md` §§13, 15, 25; approved engine-first decision | **Owner module:** undecided pending E3 ownership audit | **Inputs/sources:** research question, datasets, models, code, benchmarks, artifacts | **AI role:** draft method/check completeness/summarize results
